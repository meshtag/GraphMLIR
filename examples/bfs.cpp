...
extern "C" {
void _mlir_ciface_bfs(MemRef_descriptor m1, MemRef_descriptor m2,
                          MemRef_descriptor m3);
}
...
bool testImplementation(int argc, char *argv[], std::ptrdiff_t x,
  ...
  // Call the MLIR BFS function.
  _mlir_ciface_bfs(input, kernel, output, x, y, 0);
