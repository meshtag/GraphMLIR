...
void _mlir_ciface_djikstra(MemRef<int, 2> *graph1, MemRef<int, 2> *graph2);                      
}
...
void graph_djikstra(MemRef<int, 2> *input, MemRef<int, 2> *output) {
  detail::_mlir_ciface_djikstra(input, output);
}
} // namespace graph
